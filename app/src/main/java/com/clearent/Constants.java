...
public class Constants {
    ...
    public static final String SOFTWARE_TYPE = "Ckearent IDTech JDemo";
    public static final String SOFTWARE_TYPE_VERSION = "1.126.0";
    public static final String DEFAULT_DEVICE_SERIAL_NUMBER_SUFFIX = "03826";
    public static final long BLE_SCAN_TIMEOUT = 10000;
    public static final long BLE_MAX_SCAN_TRIES = 3;
